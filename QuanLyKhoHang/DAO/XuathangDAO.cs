...
namespace QuanLyKhoHang.DAO
{
    public class XuathangDAO
    {
        ...
        public bool InsertXuathang(string Idphieux, string Idhang, string Tenhang, string Dvt, String Luongxuat, string Giaxuat)
        {
            string query = string.Format("INSERT INTO PhieuXuat (Idphieux, Idhang, Tenhang, Dvt, Luongxuat, Giaxuat, ThanhTien) VALUES('{0}','{1}','{2}','{3}','{4}','{5}')", Idphieux, Idhang, Tenhang, Dvt, Luongxuat, Giaxuat);
