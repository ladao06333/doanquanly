...
namespace QuanLyKhoHang.DAO
{
    public class HanghoaDAO
    {
        ...
        {
            string query = string.Format("INSERT INTO HangTon(Idhang,Tenhang,Dvt,SoLuong,Gianhap,Giaxuat) VALUES('{0}','{1}','{2}','{3}','{4}','{5}')", Idhang, Tenhang, Dvt, SoLuong, Gianhap, Giaxuat);
